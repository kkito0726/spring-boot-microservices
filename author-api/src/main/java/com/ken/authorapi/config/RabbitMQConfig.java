...
public class RabbitMQConfig {
  ...
  public static final String QUEUE_BOOK_CREATED =
    "author-api.message.queue.book.created";
  public static final String QUEUE_BOOK_DELETED =
    "author-api.message.queue.book.deleted";
  public static final String QUEUE_BOOK_UPDATED =
    "author-api.message.queue.book.updated";
  ...
  @Bean
  Binding bookDeletedBinding(
    Queue bookDeletedQueue,
    FanoutExchange bookDeletedExchange
  ) {
    return BindingBuilder.bind(bookDeletedQueue()).to(bookDeletedExchange);
  }
  ...
  @Bean
  Binding bookUpdatedBinding(
    Queue bookUpdatedQueue,
